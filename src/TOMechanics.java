...
class TOMechanics {
    private TOMInterface gameHero;
    public Scanner scanner = new Scanner(System.in);

    public TOMechanics(TOMInterface gameHero) {
 ...
 //EASY mode 
     static class TOMage implements TOMInterface {
        ...
        private int experienceThreshold = 20; 
        private int playerLevel = 1;
        private int levelDamageMultiplier = 1;
        //Mob/Enemy Stats
        private int monsterHP1 = 30; //gargoyle
        private int monsterHP2 = 50; //lancer
...
public void playerAttack() {
    ...
    monsterDamage1 = random.nextInt(60) + playerLevel * levelDamageMultiplier;
    monsterDamage2 = random.nextInt(60) + playerLevel * levelDamageMultiplier;
...
public void bossCounterAttack() {
    ...
    System.out.println("\n" + getHeroType() + " takes " + damage + " damage.");
        ...
        // Calculate the score 
            int randomScoreMonster = random.nextInt(50)+1 * monsterCount;
            int randomScoreBoss = random.nextInt(200) + 100 * bossCount;
   ...
   static class TOPaladin implements TOMInterface {
        private DecimalFormat df = new DecimalFormat("0");
        //Player Stats
        private int playerHP;
        private int armor;
...
public void playerAttack() {
    ...
    monsterDamage1 = random.nextInt(30) + playerLevel * levelDamageMultiplier;
    monsterDamage2 = random.nextInt(30) + playerLevel * levelDamageMultiplier;
...
public void bossCounterAttack() {
    ...
    static class TOBeast implements TOMInterface {
        private DecimalFormat df = new DecimalFormat("0");
        //Player Stats
        private int playerHP;
        private int armor;
...
public void playerAttack() {
    ...
    if (monsterHP2 > 0) {
        ...
        public void useSkill() {
            if (turnsSinceLastSkill >= skillCooldown) {
                System.out.println("Beast used SAVAGE MAULING!");
                skillDamage = random.nextInt(50) + 50;
                opponentsTakeDamage(skillDamage);
                turnsSinceLastSkill = 0;  // Reset the cooldown
            }else {
                System.out.println("SAVAGE MAULING is on cooldown. Choose another option.");
            }
        }
